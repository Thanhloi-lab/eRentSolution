...
namespace eRentSolution.Data.Migrations
{
    ...
    [Migration("20210430031003_change_statusName")]
    partial class change_statusName
    {
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0d10cb66-b8e7-4b07-80e6-0a73da9560af",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "474d7f90-aad3-449f-a976-151d0a8edfdf",
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "83d69519-2184-4544-bae2-4386d79d8436",
                            DateChangePassword = new DateTime(2021, 4, 30, 3, 10, 2, 567, DateTimeKind.Utc).AddTicks(3443),
                            Email = "caothanhloi@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "caothanhloi@gmail.com",
                            NormalizedUserName = "thanhloi",
                            PasswordHash = "AQAAAAEAACcQAAAAEDNM4qI6SJsubURcTAVqFy7CsNtqZVQq2lj7pU7995mJv6OHo1iA/hc4tzHbb2NVxg==",
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.Censor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActionId = 1,
                            Date = new DateTime(2021, 4, 30, 3, 10, 2, 595, DateTimeKind.Utc).AddTicks(5650),
                            ProductId = 1,
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 4, 30, 3, 10, 2, 593, DateTimeKind.Utc).AddTicks(8381),
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.ProductDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 4, 30, 3, 10, 2, 594, DateTimeKind.Utc).AddTicks(6278),
                            Detail = "2 nvs .....",
                            Length = 10,

...
namespace eRentSolution.Data.Migrations
{
    ...
    [Migration("20210428125343_delete_alias")]
    partial class delete_alias
    {
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3600e703-381f-4115-814d-d39c730222b8",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a259e722-4968-4785-a048-f77f2e954c7d",
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "34d088bc-ecb8-4561-9f16-f954ef705a08",
                            DateChangePassword = new DateTime(2021, 4, 28, 12, 53, 41, 614, DateTimeKind.Utc).AddTicks(4260),
                            Email = "caothanhloi@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "caothanhloi@gmail.com",
                            NormalizedUserName = "thanhloi",
                            PasswordHash = "AQAAAAEAACcQAAAAEKeYUu52yn8LKPfosC5Myjy2ri8NdOol/mGxo6Y4fkZJUDX3Amhmby3VxjEqHn31XQ==",
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.Censor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActionId = 1,
                            Date = new DateTime(2021, 4, 28, 12, 53, 41, 644, DateTimeKind.Utc).AddTicks(7132),
                            ProductId = 1,
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 4, 28, 12, 53, 41, 642, DateTimeKind.Utc).AddTicks(7033),
            ...
            modelBuilder.Entity("eRentSolution.Data.Entities.ProductDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2021, 4, 28, 12, 53, 41, 643, DateTimeKind.Utc).AddTicks(6487),
                            Detail = "2 nvs .....",
                            Length = 10,
